...
namespace Napi {
  ...
  public:
    /// Creates a new Number value from a 32-bit signed integer.
    static Number New(
      napi_env env, ///< N-API environment
      int32_t value ///< Number value
    );

    /// Creates a new Number value from a 32-bit unsigned integer.
    static Number New(
      napi_env env,   ///< N-API environment
      uint32_t value  ///< Number value
    );

    /// Creates a new Number value from a 64-bit signed integer.
    static Number New(
      napi_env env,  ///< N-API environment
